...
import br.edu.iff.projetoSGCI.exception.Error;
import br.edu.iff.projetoSGCI.exception.NotFoundException;
import br.edu.iff.projetoSGCI.exception.PropertyError;
import br.edu.iff.projetoSGCI.exception.ValidationError;
...
public class MyRestControllerAdvice {
    ...
    public ResponseEntity erroValidacao(ConstraintViolationException e, HttpServletRequest request){
        ValidationError erro = new ValidationError(Calendar.getInstance(), 
